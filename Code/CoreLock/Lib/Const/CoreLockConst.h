 ...
 *  外环线条颜色：选中
 */
#define CoreLockCircleLineSelectedColor rgba(238,170,255,1) //rgba(34,178,246,1)


/*
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor rgba(238,170,255,1) //rgba(34,178,246,1)


/*
 *  实心圆
 */
#define CoreLockLockLineColor rgba(238,170,255,1) //rgba(34,178,246,1)
